...
export class Eth2xFli__getPositionsResultValue0Struct extends ethereum.Tuple {
...
export class Eth2xFli extends ethereum.SmartContract {
  static bind(address: Address): Eth2xFli {
    return new Eth2xFli("Eth2xFli", address);
  }
  ...
  getPositions(): Array<Eth2xFli__getPositionsResultValue0Struct> {
    let result = super.call(
      "getPositions",
    ...
    return result[0].toTupleArray<Eth2xFli__getPositionsResultValue0Struct>();
  }

  try_getPositions(): ethereum.CallResult<
    Array<Eth2xFli__getPositionsResultValue0Struct>
  > {
    let result = super.tryCall(
      "getPositions",
      "getPositions():((address,address,int256,uint8,bytes)[])",
    ...
    return ethereum.CallResult.fromValue(
      value[0].toTupleArray<Eth2xFli__getPositionsResultValue0Struct>()
    );
  }
...
export class TokenData extends Eth2xFli {
  constructor(name, address) {
    super(name, address);
    console.log('this::: iside token take constructor', this)
  }
